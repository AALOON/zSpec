...
namespace zSpec.Tests
{
    ...
    public sealed class PagingTests : TestBase
    {
        ...
        public static IEnumerable<IPaging> WithOrderBy => new[]
            {
                new Paging3 { Take = 2, OrderBy = "string"},
                new Paging3 { Take = 2, Page = 1 , OrderBy = "string"},
                new Paging3 { Page = 1 , OrderBy = "string"},
                new Paging3 {OrderBy = "string"},
